...
public class CartActivity extends AppCompatActivity {
    ...
    private void prosesPesan() {
        ...
        PostTransaksi request = new PostTransaksi(user_id, (subtotal + this.tax), this.ongkir, items);
    ...
    // untuk mengambile item yang sudah dikeranjang
            ...
            public void onResponse(Call<GetOngkir> call, Response<GetOngkir> response) {
                try {
                    if(response.body() != null && response.isSuccessful() && !response.body().isError()) {
                        ...
                        CartActivity.this.btnPesan.setVisibility(View.GONE);
                    }
                }
                catch (Exception e) {
                    Toast.makeText(CartActivity.this, "Terjadi kesalahan", Toast.LENGTH_SHORT).show();
                    ...
                    CartActivity.this.progressBar.setVisibility(View.GONE);
                }
            }

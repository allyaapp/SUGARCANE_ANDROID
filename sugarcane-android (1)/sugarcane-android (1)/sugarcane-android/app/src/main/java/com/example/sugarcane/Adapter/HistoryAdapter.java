...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull HistoryAdapter.ViewHolder holder,@SuppressLint("RecyclerView") int position) {
        ...
        double ongkir = Double.parseDouble(items.get(position).getOngkir());
        double pajak = 1000;
        double subharga = Double.parseDouble(items.get(position).getTotal_harga());
        holder.tvOngkir.setText("Rp."+ongkir);
        holder.tvPajak.setText("Rp."+pajak);
        holder.tvTotal.setText("Rp."+(ongkir + pajak + subharga));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView tvId, tvTanggal, tvTotal,tvStatus, tvOngkir, tvPajak;
        ListView listView;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvOngkir = itemView.findViewById(R.id.tv_ongkir);
